...
public class ExifUtil {
    ...
    public static Bitmap decodeBitmapWithRotation(byte[] picture, boolean frontFacing) {
        ...
        Matrix matrix = getBitmapRotation(orientation, frontFacing);
        return Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight(), matrix, true);
    }

    public static Matrix getBitmapRotation(int orientation, boolean frontFacing) {
    ...
    public static int getExifOrientation(InputStream inputStream) throws IOException {
